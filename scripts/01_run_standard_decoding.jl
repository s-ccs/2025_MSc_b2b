...
println("===============================")
println("01 - Standard ridge decoding")
println("===============================")
...
elapsed = @elapsed begin 
    ...
    condition_results = MScB2B.run_standard_decoding(
        cfg,
        cases;
        model = model,
    ...
    continuous_results = MScB2B.run_standard_decoding(
        cfg,
        cases;
        model = model,
        target = :continuous,
    ...
    # Save results
    # -----------------------------------------
    output_file = joinpath(RESULTS_DIR, "01_standard_decoidng_results.jls")
